// Vercel serverless：老师聊天代理。
// POST /api/dashboard/teacher-chat  body: {user_id, token, message}
// 转发到 ${TENCENT_API_BASE}/teacher/chat
...
export default async function handler(req, res) {
  ...
  try {
    const r = await fetch(`${base}/teacher/chat`, {
      method: 'POST',
